---
title: "Shiverer Optic Nerve Diameter"
...
# Goals
We have a dataset that contains diameters of axons in the optic nerve of wt and shiverer mice, calculated from cross-sectional area (assuming circular). We'd like to know if the mean axon diameter, or the distribution of axon diameters, differs between groups. We want to implement tests that take account of within and between animal variance.


# Load and format data
```{r message = FALSE}
df <- read_excel("Shiverer-ON-AxonDiameter.xlsx", range = "A1:I295") %>%
    pivot_longer(cols = 1:9) %>%
    drop_na() %>%
    mutate(group = as_factor(ifelse(name %in% c("C149-4555", "C149-4567", "C149-4591", "C149-4593"), "control", "mutant")))
